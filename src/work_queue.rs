...
//! work specified by Copy elements, like numbers or string slices. It is
//! implemented as an abstraction over the standard library's concurrency
//! primatives.

use std::sync::{Mutex, Arc};
use std::collections::VecDeque;

/// A generic work queue for Copy work elements.
